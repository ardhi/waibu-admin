...
import { buildParams, addOnsHandler } from './list.js'
...
const edit = {
  ...
  handler: async function (req, reply) {
    ...
    return await handler.call(this, { req, reply, params, template: 'waibuAdmin.template:/model/edit.html', addOnsHandler })
  }
}
